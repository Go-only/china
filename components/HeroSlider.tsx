  ...
  return (
    <section id="home" className="relative">
      <div className="relative min-h-[640px] w-full overflow-hidden bg-brand-800 sm:min-h-[680px] lg:min-h-[720px]">
        ...
        <div className="pointer-events-none relative mx-auto flex min-h-[640px] max-w-[1440px] flex-col justify-center px-4 pt-32 pb-32 sm:min-h-[680px] sm:px-6 lg:min-h-[720px] lg:px-10">
